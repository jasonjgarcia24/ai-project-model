...
Output defaults to templates/examples/<yaml_stem>_gantt_v<YYYYMMDD_HHMMSS>.png

Examples:
    python generate_gantt.py ../templates/examples/kickoff_example_support_triage.yaml
...
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "templates" / "examples"
...
def main():
    ...
    if args.output is None:
        ...
        args.output = str(OUTPUT_DIR / f"{yaml_path.stem}_gantt_v{version}.png")
